...
import type { BscVault, BscVaultInterface } from "../BscVault";
...
export class BscVault__factory {
  static readonly abi = _abi;
  static createInterface(): BscVaultInterface {
    return new utils.Interface(_abi) as BscVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BscVault {
    return new Contract(address, _abi, signerOrProvider) as BscVault;
  }
}
