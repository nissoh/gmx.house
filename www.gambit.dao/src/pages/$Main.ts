...
export default ({ baseRoute = '' }: Website) => component((
  ...
  return [
    ...
    mergeArray([
      ...
      $node(designSheet.main, style({ backgroundImage: `radial-gradient(70% 71% at 50% 15vh,${pallete.horizon} 0,${pallete.background} 100%)`, alignItems: 'center', placeContent: 'center' }))(
        router.match(rootRoute)(
          $column(style({ minHeight: '100vh', overflow: 'hidden', position: 'relative', margin: '0 auto', width: '100%' }), layoutSheet.spacingBig)(

            $row(style({ alignItems: 'center', width: '100%', backgroundColor: pallete.background }))(
