...
// import { IAccountSummary, ITrade, IClaim, IPagableResponse, IPageable, parseFixed } from '@gambitdao/gmx-middleware'
...
//   competitionNov2021HighestCumulative: Stream<IPagableResponse<IAccountSummary>>
//   competitionNov2021LowestCumulative: Stream<IPagableResponse<IAccountSummary>>
...
//           $Table2<IAccountSummary & {claimMap: Map<string, IClaim>, index: number}>({
